...
reader = csv.reader(open('Himachal Pradesh.csv'))
...
read_file = csv.reader(open('Himachal Pradesh.csv'))
next(read_file,None)
...
for district in unique_districts:
	file = open( "0" + str(district) + ".csv","w")
	...
	for row in state_data:
		...
		if district == row[3]:
			...
			file.write("\n")
	if phase == '21':		
		os.rename( "0" + str(district) + ".csv",str(district) + "_phase1_.csv")		
			#print district,row
