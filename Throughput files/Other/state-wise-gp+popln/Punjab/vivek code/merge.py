...
def combine(fn1,fn2, fn3):	
	...
	fn = '/home/uesr/Project/state-wise-gp+popln/Punjab/results/gp_popln_'+gcode+'.csv'
	file = open(fn, "w")

	header = "State_Name,State Cde,District_Name,District_Code,Block_Name,Block_Code,GP Name,GP Code,Latitude,Longitude,Location_OF_GP,Phase,population"
	file.write(header)
	file.write("\n")
	for i in reader3:
		i[6] = i[6].strip().lower()
